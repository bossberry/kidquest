...
- [x] **Phase 3: World Battle** — ENEMY tile collision in WorldScreen, WorldBattle.jsx wrapper, drawEnemy.js canvas sprites, MoveSelectBattleMode GB-style rewrite (HP bars, typewriter dialogue, entry flash, counterattack animations), position restore on return, App.jsx routing for world-battle. Build ✅ 2026-06-11. Note: Sleepy Bunny double-tap wake rule deferred; enemy respawn timer deferred.

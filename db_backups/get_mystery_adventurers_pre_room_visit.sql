-- ============================================================================
-- BACKUP — get_mystery_adventurers as it existed BEFORE the 2026-07-01
-- room-visit migration (20260701_mystery_adventurers_room_visit.sql).
-- This is a verbatim copy of migration 20260627_mystery_adventurers_egg.sql,
-- kept here so the pre-room-visit RPC shape can be restored if needed.
-- (Source of truth for the presumed-deployed definition — see task notes.)
-- ============================================================================

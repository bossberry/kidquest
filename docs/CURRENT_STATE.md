...
_Last updated: 2026-07-03 (Icon-first UI pass)_
...
- **Remove/swap flow**: tap occupied slot → action sheet with 🗑️ (remove) and 🔄 (swap, re-opens the zone-filtered picker on that slot) — icon-only since 2026-07-03's icon-first pass.

...
- [x] **6-element pixel art creatures in `creatureAlgorithm.js`** — Rewrote drawCreature with 12×12 pixel grid renderer. 6 elements (fire/water/thunder/nature/shadow/light) × 3 stages (baby/teen/final). Added `getCreatureName(element, evoStage)`. 2026-06-16.
